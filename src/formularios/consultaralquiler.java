...
public class consultaralquiler extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					consultaralquiler frame = new consultaralquiler();
	...
	public void RefreshTable(JTable table) {
		try {	  
				...
				ResultSet rs = st.executeQuery("SELECT alquiler.*, juego.nombre FROM alquiler join juego on alquiler.idpro = juego.idpro LIMIT "+comienzo+","+num+"");
	...
	public consultaralquiler() {
		...
		contentPane_1.setBounds(10, 30, 763, 326);
		...
		btnAnterior.setBounds(40, 213, 117, 23);
		...
		btnSiguiente.setBounds(193, 213, 117, 23);
		...
		btnBuscar.setBounds(449, 213, 117, 23);
		...
		JLabel lblConsultaCliente = new JLabel("CONSULTA DE ALQUILER DE JUEGOS");
		...
		lblConsultaCliente.setBounds(40, 0, 688, 32);
		contentPane_1.add(lblConsultaCliente);
		
		
		ControllerAlquiler cont = new ControllerAlquiler();
		total=cont.ContarAlquiler();
		comienzo=0;
